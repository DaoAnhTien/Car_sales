...
class MediumNFTShimmer extends StatefulWidget {
  ...
  @override
  _MediumNFTShimmerState createState() => _MediumNFTShimmerState();
}

class _MediumNFTShimmerState extends State<MediumNFTShimmer>
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        var circleHeight = widget.height * 4;
        return Container(
              ...
              Row(
                ...
                children: <Widget>[
                  widget.onlyShowProfilePicture
                      ? Container(
                          height: widget.circleHeight ?? width * 0.1,
                          width: widget.circleHeight ?? width * 0.1,
                          decoration: customBoxDecoration(
                              animation: _animation,
                              isRectBox: widget.isRectBox,
                              isPurplishMode: widget.isPurplishMode,
...
// **************************************PlayStoreShimmer****************************
class VipCarSlimmer extends StatefulWidget {
  final bool isDarkMode;
  final bool isPurplishMode;
  final AlignmentGeometry beginAlign;
  final AlignmentGeometry endAlign;
  ...
  @override
  _VipCarSlimmerState createState() => _VipCarSlimmerState();
}

class _VipCarSlimmerState extends State<VipCarSlimmer>
    with SingleTickerProviderStateMixin {
  late AnimationController _animationController;
  late Animation<double> _animation;
