import 'package:oke_car_flutter/widgets/custom/smoothPageIndicator/effects/indicator_effect.dart';
...
abstract class IndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (_effect.activeAfterNext && _effect.listActive.contains(i)) {
        dotPaint.color = _effect.activeDotColor;
      } else {
        dotPaint.color = _effect.dotColor;
      }
