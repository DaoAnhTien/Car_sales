...
class BoughtWidget extends GetView<HistoryOrderController> {
  const BoughtWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final listBuyingOrder = controller.listBought;
  ...
  Widget buildProcessMint(BuildContext context) {
    return Column(
        children: controller.listBought
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(AppUtil.formatMoneyInt(controller.totalListBougt() ?? 0),
              style: Style()
                  .titleStyle2
