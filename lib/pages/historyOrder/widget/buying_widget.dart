...
class BuyingWidget extends GetView<HistoryOrderController> {
  const BuyingWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final listBuyingOrder = controller.listBuyingOrder;
        ...
        delegate: SliverChildBuilderDelegate(
          (context, index) {
            return Column(
                ...
                children: [totalPrice(context), buildProcessMint(context)]);
          },
          childCount: 1,
        ),
      );
  ...
  Widget buildProcessMint(BuildContext context) {
    return Column(
        children: controller.listBuyingOrder
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(AppUtil.formatMoneyInt(controller.total() ?? 0),
              style: Style()
                  .titleStyle2
